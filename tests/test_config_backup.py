...
class TestConfigBackup:
    ...
    def test_config_backup_init(self, tmp_path_safe):
        """Test ConfigBackup initialization."""
        backup = ConfigBackup(str(tmp_path_safe))

        assert backup.backup_dir == tmp_path_safe
        assert backup.max_backups == 10
        assert backup._running is False

    def test_config_backup_custom_params(self, tmp_path_safe):
    ...
    def test_config_backup_creates_directory(self, tmp_path_safe):
        """Test that backup directory is created."""
        backup_dir = tmp_path_safe / 'subdir' / 'backups'
        ConfigBackup(str(backup_dir))

        assert backup_dir.exists()

    def test_backup(self, tmp_path_safe):
    ...
    def test_backup_with_label(self, tmp_path_safe):
    ...
    def test_restore(self, tmp_path_safe):
    ...
    def test_restore_nonexistent(self, tmp_path_safe):
    ...
    def test_list_backups(self, tmp_path_safe):
    ...
    def test_get_latest_backup(self, tmp_path_safe):
    ...
    def test_get_latest_backup_empty(self, tmp_path_safe):
    ...
    def test_delete_backup(self, tmp_path_safe):
    ...
    def test_delete_backup_nonexistent(self, tmp_path_safe):
    ...
    def test_cleanup_old_backups(self, tmp_path_safe):
        """Test cleanup of old backups."""
        backup = ConfigBackup(str(tmp_path_safe), max_backups=3)
    ...
    def test_export_backup_json(self, tmp_path_safe):
        """Test exporting backup to JSON."""
        backup = ConfigBackup(str(tmp_path_safe))
        config = {'port': 1080, 'host': '127.0.0.1'}
        backup_path = backup.backup(config)

        output_path = str(tmp_path_safe / 'export.json')
    ...
    def test_export_backup_txt(self, tmp_path_safe):
        """Test exporting backup to TXT."""
        backup = ConfigBackup(str(tmp_path_safe))
        config = {'port': 1080, 'host': '127.0.0.1'}
        backup_path = backup.backup(config)

        output_path = str(tmp_path_safe / 'export.txt')
        result = backup.export_backup(backup_path, output_path, format='txt')

        assert result is True
        assert Path(output_path).exists()

    def test_export_backup_invalid_format(self, tmp_path_safe):
        """Test exporting with invalid format."""
        backup = ConfigBackup(str(tmp_path_safe))
        backup_path = backup.backup({'port': 1080})

        output_path = str(tmp_path_safe / 'export.invalid')
        result = backup.export_backup(backup_path, output_path, format='invalid')

        assert result is False

    def test_get_statistics(self, tmp_path_safe):
        """Test getting backup statistics."""
        backup = ConfigBackup(str(tmp_path_safe), max_backups=5)
    ...
    def test_get_statistics_empty(self, tmp_path_safe):
...
class TestGetConfigBackup:
    ...
    def test_get_config_backup_custom_dir(self, tmp_path_safe):
        """Test get_config_backup with custom directory."""
        import proxy.config_backup as cb_mod
        cb_mod._backup = None

        backup = get_config_backup(str(tmp_path_safe))
...
class TestHelperFunctions:
    ...
    def test_backup_config(self, tmp_path_safe):
        """Test backup_config helper function."""
        import proxy.config_backup as cb_mod
        cb_mod._backup = ConfigBackup(str(tmp_path_safe))

        result = backup_config({'port': 1080})

        assert result is not None

    def test_restore_config(self, tmp_path_safe):
    ...
    def test_list_config_backups(self, tmp_path_safe):
