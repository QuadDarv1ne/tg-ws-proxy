...
## 🚀 Следующий релиз: v2.5.4

**Выполнено:**
- [x] Рефакторинг `_edit_config_dialog()` — 5 подметодов
- [x] Удаление дублирования `_human_bytes` в tray.py
- [x] Очистка импортов в tray.py (socket, asyncio)
- [x] Упрощение управления автостартом
- [x] Удаление избыточных алиасов констант в tg_ws_proxy.py
- [x] Унификация обработки ошибок в `_bridge_ws()` и `_bridge_tcp()`
