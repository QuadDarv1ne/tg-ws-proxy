...
#### Безопасность (v2.13.0)
- [x] Белый список IP-адресов клиентов — `proxy/constants.py`, `tray.py` ✅
- [x] Поддержка логина/пароля для прокси — уже реализовано
- [ ] Валидация конфигурации при сохранении — `tray.py` (частично ✅)

#### Стабильность (v2.13.0)
- [x] Обработка ошибок WebSocket — улучшить переподключение
...
#### Тесты (v2.13.0)
- [x] Integration tests для веб-панели — `tests/test_web_dashboard.py` ✅
...
- [ ] Пройти mypy без ошибок (11 ошибок)
- [ ] Исправить ruff нарушения (682 нарушения, 388 автоисправляемых)
